...
- This command remains snapshot-bound; it does not include working-memory state or recall-only artifact overlays unless you explicitly use <a href="/en/docs/commands/memory/recall">`memory recall`</a>.
