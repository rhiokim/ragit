...
- If you are onboarding a new project, read <a href="/en/docs/getting-started">Getting Started</a> first, then run `ingest` after `init`.
...
- JSON output reports `mode`, `processed`, `skipped`, `masked`, `commitSha`, `manifestPath`, `plannedFiles`, `deletedDocumentIds`, and `admission`.
