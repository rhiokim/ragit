...
Read <a href="/en/docs/getting-started">Getting Started</a> if you are applying RAGit to a new project.
Read <a href="/en/docs/quickstart">Quickstart</a> if you want a short map of the docs and paths.
